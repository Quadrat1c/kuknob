...
Room.prototype.gatherIntel = function () {
  ...
  kuknob.log('intel', this.name).debug('Gathering intel after', intel.lastScan && Game.time - intel.lastScan || 'infinite', 'ticks.');
  ...
  for (let i in structures) {
    ...
    if (structureType == STRUCTURE_POWER_BANK) {
      ...
      kuknob.log('intel', this.name).info('Power bank found!');
